...
export const App = () => {
  ...
  useEffect(() => {
        const contents = document.getElementById("redirectBlock");
        ...
        const handleClick = (event) => {
          ...
          if (target.tagName === "A") {
            ...
            if (window.confirm("Хотите перейти по данной ссылке?")) {
  ...
  return (
    <>
        ...
        <section>
          ...
          <div className={cn(styles.center_block,styles.list)} id={"redirectBlock"}>
            <List orientation={"vertical"}>
